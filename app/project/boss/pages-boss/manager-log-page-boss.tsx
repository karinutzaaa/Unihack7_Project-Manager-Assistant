              ...
              <Calendar
                onDayPress={(day) => {
                  ...
                  try {
                    ...
                    router.push({ pathname: "/project/boss/pages-boss/calendar-deadline-page-boss", params: { date, projects: payload } } as any);
                  } catch {
                    router.push({ pathname: "/project/boss/pages-boss/calendar-deadline-page-boss", params: { date } } as any);
                  }
                }}
